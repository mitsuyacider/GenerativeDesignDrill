...
function setup() {
  ...
  createParticleText(/* str = */ "MITSUYA", /* gap = */ -20);
  createParticleText(/* str = */ "BAUHAUS", /* gap = */ 120);

  liquid = new Liquid(0, height / 2 - 140, width, 280, 0.01);
  // textFont("Helvetica");
  // noLoop();
}

function createParticleText(str, gap) {
  push();
  ...
  const character = new Character(points);
